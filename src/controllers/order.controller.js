    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, orderService.createOrder(req.body)];
            case 1:
                order = _a.sent();
...
var getOrderById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderService.getOrderById(parseInt(req.params.id))];
            case 1:
                order = _a.sent();
                if (order) {
                    res.json(order);
...
var updateOrderStatus = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderService.updateOrderStatus(parseInt(req.params.id), req.body.status)];
            case 1:
                order = _a.sent();
                if (order) {
                    res.json(order);
