...
var fetchPrices = function (productName) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.post('http://localhost:8000/scrape', {
                        item: productName,
                    })];
            case 1:
                response = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error('Error fetching prices from Python scraper:', error_1);
                ...
                if (axios_1.default.isAxiosError(error_1) && error_1.code === 'ECONNREFUSED') {
