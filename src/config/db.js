...
var connectMySQL = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                console.log("Attempting to connect to MySQL at ".concat(process.env.MYSQL_HOST || 'localhost', "..."));
                console.log("Database: ".concat(process.env.MYSQL_DATABASE || 'food_delivery'));
                console.log("User: ".concat(process.env.MYSQL_USER || 'root'));
